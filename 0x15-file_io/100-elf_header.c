...
/**
 * check_magic - Prints the magic numbers of an ELF header.
 * @e_ident: A pointer to an array containing the ELF magic numbers.
...
/**
 * check_class - Prints the class of an ELF header.
...
/**
 * check_data - Prints the data of an ELF header.
 * @e_ident: A pointer to an array containing the ELF class.
 */
void check_data(unsigned char *e_ident)
{
...
/**
 * check_type - Prints the type of an ELF header.
 * @e_type: The ELF type.
 * @e_ident: A pointer to an array containing the ELF class.
 */
void check_type(unsigned int e_type, unsigned char *e_ident)
...
/**
 * check_entry - Prints the entry point of an ELF header.
